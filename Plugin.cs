...
namespace Food_Slot_Tweaks
{
    ...
    public class Food_Slot_TweaksPlugin : BaseUnityPlugin
    {
        internal const string ModName = "Food_Slot_Tweaks";
        ...
        public static readonly ManualLogSource Food_Slot_TweaksLogger = BepInEx.Logging.Logger.CreateLogSource(ModName);
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                Food_Slot_TweaksLogger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                Food_Slot_TweaksLogger.LogError($"There was an issue loading your {ConfigFileName}");
                Food_Slot_TweaksLogger.LogError("Please check your config entries for spelling and format!");
            }
        }
